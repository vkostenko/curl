...
short: {
    ...
    "Et": "tcp-fastopen",
    "Eu": "proxy-tlsuser",
    "Ev": "proxy-tlspassword",
    "Ew": "proxy-tlsauthtype",
    "Ex": "proxy-cert",
    "Ey": "proxy-cert-type",
    "Ez": "proxy-key",
    "E0": "proxy-key-type",
...
long: {
    ...
    "cert": {
        "title": "-E, --cert &lt;certificate[:password]>",
    ...
    "connect-to": {
        "title": "--connect-to &lt;HOST1:PORT1:HOST2:PORT2>",
    ...
    "form-string": {
        "title": "-Fs, --form-string &lt;name=string>",
    ...
    "http2-prior-knowledge": {
        "title": "-03, --http2-prior-knowledge",
    ...
    "keepalive-time": {
        ...
        "text": "<div class=\"short_info\">Interval time for keepalive probes<\/div><p>This option sets the time a connection needs to remain idle before sendingkeepalive probes and the time between individual keepalive probes. It iscurrently effective on operating systems offering the TCP_KEEPIDLE andTCP_KEEPINTVL socket options (meaning Linux, recent AIX, HP-UX and more). This option has no effect if --no-keepalive is used.<p>If this option is used several times, the last one will be used. Ifunspecified, the option defaults to 60 seconds.<p>Added in 7.18.0",
        "type": "string"
    },
    "key-type": {
        "title": "-Ed, --key-type &lt;type>",
    ...
    "preproxy": {
        "title": "-xa, --preproxy [protocol:\/\/]host[:port]",
    ...
    "proxy-cert": {
        "title": "-Ex, --proxy-cert &lt;cert[:passwd]>",
    ...
    "proxy-header": {
        "title": "-Hp, --proxy-header &lt;header\/@file>",
    ...
    "proxy-ssl-allow-beast": {
        "title": "-E4, --proxy-ssl-allow-beast",
    ...
    "proxy-tlsauthtype": {
        "title": "-Ew, --proxy-tlsauthtype &lt;type>",
    ...
    "proxy-tlspassword": {
        "title": "-Ev, --proxy-tlspassword &lt;string>",
    ...
    "proxy-user": {
        "title": "-U, --proxy-user &lt;user:password>",
    ...
    "proxy": {
        "title": "-x, --proxy [protocol:\/\/]host[:port]",
    ...
    "resolve": {
        "title": "--resolve &lt;host:port:address>",
    ...
    "socks5-hostname": {
        "title": "--socks5-hostname &lt;host[:port]>",
    ...
    '--': {
        'title': '--',
        'text': '<div class=\"short_info\">Stop accepting flags</div>',
        'type': 'none'
    }
}
};